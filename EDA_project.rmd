...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(aes(x=alcohol, y=volatile.acidity, color = grade), 
       data=red_wine) +
...
acetic_acid_label <- expression("Acetic acid concentration" ~ (g/dm^{3}))
sulphates_label <- expression("Sulphate concentration" ~ (g/dm^{3}))
alcohol_label <- "Alcohol (% volume)"

p1 <- ggplot(aes(x = quality, y = volatile.acidity, color = grade), 
             data = red_wine) +
  geom_boxplot() +
  guides(fill = FALSE) +
  ggtitle('Volatile acidity vs. quality') +
  xlab('Quality') + 
  ylab(acetic_acid_label)

p2 <- ggplot(aes(x = quality, y = sulphates, color = grade), 
             data = red_wine) +
  geom_boxplot() +
  guides(fill = FALSE) +
...
p3 <- ggplot(aes(x = quality, y = alcohol, color = grade), 
             data = red_wine) +
  geom_boxplot() +
  guides(fill = FALSE) +
